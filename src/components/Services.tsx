  ...
  return (
    <Section id="how-to-use">
      <div className="container">
        <Heading
          title="GenerativeAI made for creators"
        ...
        <div className="relative ">
          <div className=" relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <Generating className="absolute left-4 right-4 bottom-4 border-n-1/10 border lg:left-1/2  lg:right-auto lg:bottom-8 lg:-translate-x-1/2 xl:w-[30rem] lg:w-[30rem] " />
          </div>
          <div className=" relative z-1 grid gap-5 lg:grid-cols-2 ">
            <div className="border border-n-1/10 rounded-3xl relative overflow-hidden min-h-[39rem]">
